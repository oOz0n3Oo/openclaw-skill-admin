...
const mockRegistryUrl = vi.fn((path, registry) => {
...
vi.mock('../../http.js', () => ({
    ...
    registryUrl: (...args) => mockRegistryUrl(...args),
}));
...
const { clampLimit, cmdExplore, cmdInstall, cmdSearch, cmdUninstall, cmdUpdate, formatExploreLine } = await import('./skills');
